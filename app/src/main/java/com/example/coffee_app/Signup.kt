...
fun SignUp(navController: NavHostController) {
    ...
    Box(
        ...
        Column(
            ...
            TextField(
                value = textfield3, onValueChange = { textfield3 = it },
            ...
            Text(
                text = "Forgot Password", color = Color(0xFF8B5742),
            ...
            Text(text = buildAnnotatedString {
                withStyle(style = SpanStyle(Color(0xFF8B5742))) { append("Already have an account?") }
                withStyle(
                    style = SpanStyle(
                        Color(0xFF392A25),
                        fontWeight = FontWeight.Bold
            ...
            Row {
                Image(
                    painter = painterResource(id = R.drawable.fb), contentDescription = null,
                ...
                Image(
                    painter = painterResource(id = R.drawable.telegram), contentDescription = null,
                    colorFilter = ColorFilter.tint(Color(0xFF392A25)),
                    modifier = Modifier.size(40.dp)
                )
            }
